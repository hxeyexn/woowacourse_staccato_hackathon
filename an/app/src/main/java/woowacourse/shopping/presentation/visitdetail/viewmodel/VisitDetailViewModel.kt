...
class VisitDetailViewModel() : ViewModel() {
    private val _visitDefault = MutableLiveData<VisitDefault>()
    val visitDefault: LiveData<VisitDefault> get() = _visitDefault

    private val _visitLogs = MutableLiveData<List<Comment>>()
    val visitLogs: LiveData<List<Comment>> get() = _visitLogs
